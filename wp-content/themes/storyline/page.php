										...
										<div class="icon-soc-container">
											<div class="share-btns"><?php
                                                       if($post_showcategory != "hide"){ ?>
                                                            ...
                                                            <div class="empty-left user-holder"> <a  href="<?php comments_link(); ?>" id='linkclick' class="linkclick"><i class="icon-comments icon-large"></i> <?php comments_number( '0', '1', '%' ); ?></a>
                                                            </div>
                                                            <?php };?>
...
jQuery(document).ready(function ($) {
	...
	$("#billing_country_field").addClass("<?php global $post_color; echo $post_color;?> ");
	$("#billing_country").msDropDown();
	$(".shipping-calculator-form").addClass("<?php global $post_color; echo $post_color;?> ");
	$("#calc_shipping_country").msDropDown();
	$("#shipping_country_field").addClass("<?php global $post_color; echo $post_color;?> ");
	$("#shipping_country").msDropDown();
	$("#calc_shipping_state_field").addClass("<?php global $post_color; echo $post_color;?> ");
	$("#calc_shipping_state").msDropDown();
	$("#shipping_state_field").addClass("<?php global $post_color; echo $post_color;?> ");
	$("#shipping_state").msDropDown();
	$("#billing_state_field").addClass("<?php global $post_color; echo $post_color;?> ");
	$("#billing_state").msDropDown();
